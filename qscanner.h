...
enum { K_ALTER = NEXT_KEYWORD, K_AVERAGE, K_BY, K_COUNT, K_CREATE, 
	K_DELETE, K_DROP, K_ENSURE, K_EXTEND, K_INTO, K_INDEX, 
	K_INSERT, K_INTERSECT, K_JOIN, K_KEY, K_LEFTJOIN, K_LOWER, K_MAX, 
