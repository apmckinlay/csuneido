...
double Intersect::optimize2(const Fields& index, const Fields& needs,
	...
	double cost2 =
		source2->optimize(index, needs2, needs2_k, is_cursor, false) +
		source->optimize(ki1, needs1, Fields(), is_cursor, false) +
		OUT_OF_ORDER;
