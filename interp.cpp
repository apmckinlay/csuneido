	...
	for (;;)
		try {
			...
			case I_SUPER:
				...
				break;
			case I_PUSH_LITERAL | 0:
			case I_PUSH_LITERAL | 1:
			case I_PUSH_LITERAL | 2:
			case I_PUSH_LITERAL | 3:
			case I_PUSH_LITERAL | 4:
			case I_PUSH_LITERAL | 5:
			case I_PUSH_LITERAL | 6:
			case I_PUSH_LITERAL | 7:
			case I_PUSH_LITERAL | 8:
			case I_PUSH_LITERAL | 9:
			case I_PUSH_LITERAL | 10:
			case I_PUSH_LITERAL | 11:
			case I_PUSH_LITERAL | 12:
			case I_PUSH_LITERAL | 13:
			case I_PUSH_LITERAL | 14:
			case I_PUSH_LITERAL | 15:
			...
			case I_EQ_AUTO | 7:
				local[op & 7] = TOP();
				break;
			case I_EQ_AUTO_POP | 0:
			case I_EQ_AUTO_POP | 1:
			case I_EQ_AUTO_POP | 2:
			case I_EQ_AUTO_POP | 3:
			case I_EQ_AUTO_POP | 4:
			case I_EQ_AUTO_POP | 5:
			case I_EQ_AUTO_POP | 6:
			case I_EQ_AUTO_POP | 7:
				local[op & 7] = TOP();
				POP();
				break;
			case I_CALL_GLOBAL | 0:
			case I_CALL_GLOBAL | 1:
			case I_CALL_GLOBAL | 2:
			case I_CALL_GLOBAL | 3:
			case I_CALL_GLOBAL | 4:
			case I_CALL_GLOBAL | 5:
			case I_CALL_GLOBAL | 6:
			case I_CALL_GLOBAL | 7:
				nargs = op & 7;
				CALLX(
					globals[i = fetch_global()], CALL, nargs, 0, 0, globals(i));
				break;
			case I_CALL_GLOBAL_POP | 0:
			case I_CALL_GLOBAL_POP | 1:
			case I_CALL_GLOBAL_POP | 2:
			case I_CALL_GLOBAL_POP | 3:
			case I_CALL_GLOBAL_POP | 4:
			case I_CALL_GLOBAL_POP | 5:
			case I_CALL_GLOBAL_POP | 6:
			case I_CALL_GLOBAL_POP | 7:
				nargs = op & 7;
			...
			case I_CALL_MEM | 7:
				...
				break;
			case I_CALL_MEM_POP | 0:
			case I_CALL_MEM_POP | 1:
			case I_CALL_MEM_POP | 2:
			case I_CALL_MEM_POP | 3:
			case I_CALL_MEM_POP | 4:
			case I_CALL_MEM_POP | 5:
			case I_CALL_MEM_POP | 6:
			case I_CALL_MEM_POP | 7:
				nargs = op & 7;
				CALLTOPPOP(fetch_member(), nargs, 0, 0);
				break;
			case I_CALL_MEM_SELF | 0:
			case I_CALL_MEM_SELF | 1:
			case I_CALL_MEM_SELF | 2:
			case I_CALL_MEM_SELF | 3:
			case I_CALL_MEM_SELF | 4:
			case I_CALL_MEM_SELF | 5:
			case I_CALL_MEM_SELF | 6:
			case I_CALL_MEM_SELF | 7:
				nargs = op & 7;
				mem = fetch_member();
				CALLX(self, mem, nargs, 0, 0, mem.str());
				break;
			case I_CALL_MEM_SELF_POP | 0:
			case I_CALL_MEM_SELF_POP | 1:
			case I_CALL_MEM_SELF_POP | 2:
			case I_CALL_MEM_SELF_POP | 3:
			case I_CALL_MEM_SELF_POP | 4:
			case I_CALL_MEM_SELF_POP | 5:
			case I_CALL_MEM_SELF_POP | 6:
			case I_CALL_MEM_SELF_POP | 7:
				nargs = op & 7;
				CALLPOP(self, fetch_member(), nargs, 0, 0);
				break;
			case I_PUSH | SUB:
			case I_PUSH | SUB_SELF:
			case I_PUSH | LITERAL:
			case I_PUSH | AUTO:
			case I_PUSH | MEM:
			case I_PUSH | MEM_SELF:
			case I_PUSH | DYNAMIC:
			case I_PUSH | GLOBAL:
				PUSH(get(op));
				break;
			...
			case I_ADDEQ | (AUTO << 4):
			case I_ADDEQ | (DYNAMIC << 4):
			case I_ADDEQ | (MEM << 4):
			case I_ADDEQ | (MEM_SELF << 4):
			case I_SUBEQ | (SUB << 4):
			case I_SUBEQ | (SUB_SELF << 4):
			case I_SUBEQ | (AUTO << 4):
			case I_SUBEQ | (DYNAMIC << 4):
			case I_SUBEQ | (MEM << 4):
			case I_SUBEQ | (MEM_SELF << 4):
			case I_CATEQ | (SUB << 4):
			case I_CATEQ | (SUB_SELF << 4):
			case I_CATEQ | (AUTO << 4):
			case I_CATEQ | (DYNAMIC << 4):
			case I_CATEQ | (MEM << 4):
			case I_CATEQ | (MEM_SELF << 4):
			case I_MULEQ | (SUB << 4):
			case I_MULEQ | (SUB_SELF << 4):
			case I_MULEQ | (AUTO << 4):
			case I_MULEQ | (DYNAMIC << 4):
			case I_MULEQ | (MEM << 4):
			case I_MULEQ | (MEM_SELF << 4):
			case I_DIVEQ | (SUB << 4):
			case I_DIVEQ | (SUB_SELF << 4):
			case I_DIVEQ | (AUTO << 4):
			case I_DIVEQ | (DYNAMIC << 4):
			case I_DIVEQ | (MEM << 4):
			case I_DIVEQ | (MEM_SELF << 4):
			case I_MODEQ | (SUB << 4):
			case I_MODEQ | (SUB_SELF << 4):
			case I_MODEQ | (AUTO << 4):
			case I_MODEQ | (DYNAMIC << 4):
			case I_MODEQ | (MEM << 4):
			case I_MODEQ | (MEM_SELF << 4):
			case I_LSHIFTEQ | (SUB << 4):
			case I_LSHIFTEQ | (SUB_SELF << 4):
			case I_LSHIFTEQ | (AUTO << 4):
			case I_LSHIFTEQ | (DYNAMIC << 4):
			case I_LSHIFTEQ | (MEM << 4):
			case I_LSHIFTEQ | (MEM_SELF << 4):
			case I_RSHIFTEQ | (SUB << 4):
			case I_RSHIFTEQ | (SUB_SELF << 4):
			case I_RSHIFTEQ | (AUTO << 4):
			case I_RSHIFTEQ | (DYNAMIC << 4):
			case I_RSHIFTEQ | (MEM << 4):
			case I_RSHIFTEQ | (MEM_SELF << 4):
			case I_BITANDEQ | (SUB << 4):
			case I_BITANDEQ | (SUB_SELF << 4):
			case I_BITANDEQ | (AUTO << 4):
			case I_BITANDEQ | (DYNAMIC << 4):
			case I_BITANDEQ | (MEM << 4):
			case I_BITANDEQ | (MEM_SELF << 4):
			case I_BITOREQ | (SUB << 4):
			case I_BITOREQ | (SUB_SELF << 4):
			case I_BITOREQ | (AUTO << 4):
			case I_BITOREQ | (DYNAMIC << 4):
			case I_BITOREQ | (MEM << 4):
			case I_BITOREQ | (MEM_SELF << 4):
			case I_BITXOREQ | (SUB << 4):
			case I_BITXOREQ | (SUB_SELF << 4):
			case I_BITXOREQ | (AUTO << 4):
			case I_BITXOREQ | (DYNAMIC << 4):
			case I_BITXOREQ | (MEM << 4):
			case I_BITXOREQ | (MEM_SELF << 4):
			case I_EQ | (SUB << 4):
			case I_EQ | (SUB_SELF << 4):
			case I_EQ | (AUTO << 4):
			case I_EQ | (DYNAMIC << 4):
			case I_EQ | (MEM << 4):
			case I_EQ | (MEM_SELF << 4):
			case I_PREINC | (SUB << 4):
			case I_PREINC | (SUB_SELF << 4):
			case I_PREINC | (AUTO << 4):
			case I_PREINC | (DYNAMIC << 4):
			case I_PREINC | (MEM << 4):
			case I_PREINC | (MEM_SELF << 4):
			case I_PREDEC | (SUB << 4):
			case I_PREDEC | (SUB_SELF << 4):
			case I_PREDEC | (AUTO << 4):
			case I_PREDEC | (DYNAMIC << 4):
			case I_PREDEC | (MEM << 4):
			case I_PREDEC | (MEM_SELF << 4):
			case I_POSTINC | (SUB << 4):
			case I_POSTINC | (SUB_SELF << 4):
			case I_POSTINC | (AUTO << 4):
			case I_POSTINC | (DYNAMIC << 4):
			case I_POSTINC | (MEM << 4):
			case I_POSTINC | (MEM_SELF << 4):
			case I_POSTDEC | (SUB << 4):
			case I_POSTDEC | (SUB_SELF << 4):
			case I_POSTDEC | (AUTO << 4):
			case I_POSTDEC | (DYNAMIC << 4):
			case I_POSTDEC | (MEM << 4):
			case I_POSTDEC | (MEM_SELF << 4): {
				Value ob;
				Value x;
				Value y;
				Value m;
				...
				// assignment operators need old value EXCEPT straight
				// assignment
				...
				case I_DIVEQ:
					...
					break;
				case I_MODEQ:
					z = x = x.integer() % y.integer();
					break;
				case I_LSHIFTEQ:
					z = x = (uint32_t) x.integer() << y.integer();
					break;
				case I_RSHIFTEQ:
					z = x = (uint32_t) x.integer() >> y.integer();
					break;
				case I_BITANDEQ:
					z = x = (uint32_t) x.integer() & (uint32_t) y.integer();
					break;
				case I_BITOREQ:
					z = x = (uint32_t) x.integer() | (uint32_t) y.integer();
					break;
