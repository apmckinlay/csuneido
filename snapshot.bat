...
del suneido%1.zip
zip -9 suneido%1.zip suneido.exe suneido.db scilexer.dll libhpdf.dll clucene.dll hunspell.exe en_US.aff en_US.dic splash.bmp jsuneido.jar mylib.su mybook.su mycontacts.su
del jsuneido.jar
del suneido.db
