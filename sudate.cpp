...
Value SuDate::instantiate(short nargs, short nargnames, short* argnames, int each)
	{
	if (nargs == 0)
		{
		return new SuDate();
...
Value SuDate::FormatEn(short nargs, short nargnames, short* argnames, int each)
	{
	if (nargs != 1)
...
Value SuDate::MinusDays(short nargs, short nargnames, short* argnames, int each)
	{
...
Value SuDate::MinusSeconds(short nargs, short nargnames, short* argnames, int each)
	{
	if (nargs != 1 || nargnames != 0)
...
Value SuDate::Millisecond(short nargs, short nargnames, short* argnames, int each)
	{
