...
BUILTIN(SocketClient,
	...
	int timeoutConnect =
		(int) (ARG(3).number()->to_double() * 1000); // milliseconds
	SuSocketClient* sc = new SuSocketClient(Fibers::inMain()
...
Value CallClass::call(Value self, Value member, short nargs, short nargnames,
	...
	// construct a "master" instance, which will be duplicated for each
	// connection
