...
int Scanner::nextall() {
	...
	for (;;) {
		...
		case '/':
			...
			case '*':
				for (++si;
					 source[si] && (source[si] != '*' || source[si + 1] != '/');
					 ++si)
					;
				if (source[si])
					si += 2;
...
static Keyword words[] = {{"and", T_AND}, {"bool", K_BOOL}, {"break", K_BREAK},
	{"buffer", K_BUFFER}, {"callback", K_CALLBACK}, {"case", K_CASE},
	{"catch", K_CATCH}, {"char", K_INT8}, {"class", K_CLASS},
	{"continue", K_CONTINUE}, {"default", K_DEFAULT}, {"dll", K_DLL},
	{"do", K_DO}, {"double", K_DOUBLE}, {"else", K_ELSE}, {"false", K_FALSE},
	{"float", K_FLOAT}, {"for", K_FOR}, {"forever", K_FOREVER},
	{"function", K_FUNCTION}, {"gdiobj", K_GDIOBJ}, {"handle", K_HANDLE},
	{"if", K_IF}, {"in", K_IN}, {"int16", K_INT16}, {"int32", K_INT32},
	{"int64", K_INT64}, {"int8", K_INT8}, {"is", I_IS}, {"isnt", I_ISNT},
	{"long", K_INT32}, {"new", K_NEW}, {"not", I_NOT}, {"or", T_OR},
	{"pointer", K_POINTER}, {"resource", K_RESOURCE}, {"return", K_RETURN},
...
int Scanner::keywords(const char* s) {
	std::pair<Keyword*, Keyword*> p =
		std::equal_range(words, words + nwords, s, ScannerLt());
...
static Result results[] = {{T_AND, 0}, {K_BREAK, 0}, {K_CASE, 0}, {K_CATCH, 0},
	{K_CONTINUE, 0}, {K_CLASS, 0}, {K_CALLBACK, 0}, {K_DEFAULT, 0}, {K_DLL, 0},
	{K_DO, 0}, {K_ELSE, 0}, {K_FOR, 0}, {K_FOREVER, 0}, {K_FUNCTION, 0},
	...
	{I_ADDEQ, 0}, {T_NUMBER, "1"}, {T_NUMBER, "1"}, {I_MOD, 0}, {T_NUMBER, "2"},
	{T_STRING, "id"}};
