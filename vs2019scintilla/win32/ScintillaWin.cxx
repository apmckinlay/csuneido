 ...
 *	Reference: vs2019suneido -> scihwnds.cpp
 */
...
void SetWindowSciPointer(HWND hWnd, void* ptr) {
	...
	try {
		...
		if (sciThis == nullptr) {
			if (iMessage == WM_CREATE) {
				...
				SetWindowSciPointer(hWnd, pCreate->lpCreateParams);
				return 0;
			} else {
