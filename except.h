...
#define except(msg) ((osexcept() << msg), except_()) // NOLINT

#define except_err(msg) ((osexcept() << msg), except_err_()) // NOLINT

#define except_if(e, msg) ((e) ? except_err(msg) : (void) 0)
...
#define verify(e) ((e) ? (void) 0 : error("assert failed: " << #e))
